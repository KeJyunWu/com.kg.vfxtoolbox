...
Shader "Noise"
{
	Properties
	{
		...
		_GlobalUV_ScrollSpeed("GlobalUV_ScrollSpeed", Range( 0 , 1)) = 0
		_Effect_Base_ResultMul("Effect_Base_ResultMul", Range( 0 , 100)) = 1
		_Effect_Base_NoiseScale("Effect_Base_NoiseScale", Range( 0 , 100)) = 1
		_Effect_Base_UVTwirl_ScrollSpeed("Effect_Base_UVTwirl_ScrollSpeed", Float) = 1
		_Effect_Base_UVTwirl_Intensity("Effect_Base_UVTwirl_Intensity", Range( 0 , 10)) = 5.294117
		_Effect_Base_UVTwirl_Center("Effect_Base_UVTwirl_Center", Vector) = (0,0,0,0)
		_Effect_Base_UVWarp_ScrollSpeed("Effect_Base_UVWarp_ScrollSpeed", Float) = 1
		_Effect_Base_UVWarp_Intensity("Effect_Base_UVWarp_Intensity", Range( 0 , 1)) = 0
		_Effect_Base_UVWarp_NoiseScale("Effect_Base_UVWarp_NoiseScale", Range( 0 , 20)) = 1
		_Effect_Base_UVWarp2_NoiseScale("Effect_Base_UVWarp2_NoiseScale", Range( 0 , 20)) = 8.48966
		_Effect_Wave_ResultMul("Effect_Wave_ResultMul", Range( 0 , 20)) = 3
		_Effect_Wave_Scale("Effect_Wave_Scale", Range( 0 , 10)) = 5
		_Effect_Wave_ScrollSpeed("Effect_Wave_ScrollSpeed", Range( 0 , 1)) = 0.1
		_Effect_Wave_ResultPower("Effect_Wave_ResultPower", Range( 0 , 10)) = 3
		_Effect_Scan_ResultMul("Effect_Scan_ResultMul", Range( 0 , 10)) = 3
		_Effect_Scan_ModeLerp("Effect_Scan_ModeLerp", Range( 0 , 1)) = 0.1
		_Effect_Scan_ResultPower("Effect_Scan_ResultPower", Range( 0 , 10)) = 3
		_Effect_Scan_UVWarpScale("Effect_Scan_UVWarpScale", Range( 0 , 10)) = 0.1
		_Effect_Scan_Scale("Effect_Scan_Scale", Range( 0 , 10)) = 0.1
		_Effect_Scan_ScrollSpeed("Effect_Scan_ScrollSpeed", Range( -1 , 1)) = 0.1
		_Effect_FBM_ResultMul("Effect_FBM_ResultMul", Range( 0 , 10)) = 0
		_Effect_FBM_Frequency("Effect_FBM_Frequency", Range( 0 , 5)) = 0
		_Effect_FBM_Octaves("Effect_FBM_Octaves", Range( 0 , 5)) = 0
		_Effect_FBM_Lacunarity("Effect_FBM_Lacunarity", Range( 0 , 5)) = 0
		_Effect_FBM_Gain("Effect_FBM_Gain", Range( 0 , 5)) = 0
		_Effect_Mask_ResultMul("Effect_Mask_ResultMul", Range( 0 , 1)) = 3
		_Effect_Mask_PixelsNum("Effect_Mask_PixelsNum", Range( 1 , 200)) = 3
		_Effect_Mask_NoiseScale("Effect_Mask_NoiseScale", Range( 0 , 30)) = 3
		_Effect_Mask_NoiseScrollSpeed("Effect_Mask_NoiseScrollSpeed", Range( 0 , 1)) = 3
		_Effect_Mask_ResultPower("Effect_Mask_ResultPower", Range( 0 , 10)) = 3
		_ScriptTime("ScriptTime", Float) = 0
		_Effect_Wave_PivotOffset("Effect_Wave_PivotOffset", Vector) = (0,0,0,0)
		_TextureRatio("TextureRatio", Float) = 2
	...
	SubShader
	{
		...
		{ 
			...
			uniform float _Effect_Mask_NoiseScrollSpeed;
			...
			float4 NoiseGenerater_KJ3_g19( float2 UV, float Frequency, float octaves, float lacunarity, float gain )
			{
				float _fbmResult = fbm(UV*Frequency, octaves, lacunarity, gain);
				return float4(_fbmResult,_fbmResult,_fbmResult,1);
			}
			
			float4 NoiseGenerater_KJ3_g20( float2 UV, float Frequency, float octaves, float lacunarity, float gain )
			{
				float _fbmResult = fbm(UV*Frequency, octaves, lacunarity, gain);
				return float4(_fbmResult,_fbmResult,_fbmResult,1);
			}
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float2 UV3_g19 = GlobalUV63;
				float Frequency3_g19 = _Effect_FBM_Frequency;
				float octaves3_g19 = (float)(int)_Effect_FBM_Octaves;
				float lacunarity3_g19 = _Effect_FBM_Lacunarity;
				float gain3_g19 = _Effect_FBM_Gain;
				float4 localNoiseGenerater_KJ3_g19 = NoiseGenerater_KJ3_g19( UV3_g19 , Frequency3_g19 , octaves3_g19 , lacunarity3_g19 , gain3_g19 );
				float2 UV3_g20 = ( GlobalUV63 + float2( 0.454,0.157 ) );
				float Frequency3_g20 = _Effect_FBM_Frequency;
				float octaves3_g20 = (float)(int)_Effect_FBM_Octaves;
				float lacunarity3_g20 = _Effect_FBM_Lacunarity;
				float gain3_g20 = _Effect_FBM_Gain;
				float4 localNoiseGenerater_KJ3_g20 = NoiseGenerater_KJ3_g20( UV3_g20 , Frequency3_g20 , octaves3_g20 , lacunarity3_g20 , gain3_g20 );
				float2 appendResult140 = (float2(localNoiseGenerater_KJ3_g19.x , localNoiseGenerater_KJ3_g20.x));
				...
				float temp_output_269_0 = ( ScriptTime257 * _Effect_Mask_NoiseScrollSpeed );
				float time239 = temp_output_269_0;
				float2 appendResult254 = (float2(0.0 , temp_output_269_0));
				float pixelWidth235 =  1.0f / _Effect_Mask_PixelsNum;
				float pixelHeight235 = 1.0f / _Effect_Mask_PixelsNum;
				half2 pixelateduv235 = half2((int)(( Local_BaseUV282 + appendResult254 ).x / pixelWidth235) * pixelWidth235, (int)(( Local_BaseUV282 + appendResult254 ).y / pixelHeight235) * pixelHeight235);
				...
				float4 temp_cast_8 = (( ( ( simpleNoise38 * _Effect_Base_ResultMul ) + ( localNoiseGenerater_KJ3_g26.x * _Effect_FBM_ResultMul ) + ( pow( saferPower78 , _Effect_Wave_ResultPower ) * _Effect_Wave_ResultMul ) + ( _Effect_Scan_ResultMul * pow( lerpResult193 , _Effect_Scan_ResultPower ) ) ) * lerpResult245 )).xxxx;
				

				finalColor = temp_cast_8;
...
/*ASEBEGIN
Version=18400
2048;0;2048;1091;7416.058;318.7224;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;280;-7251.506,-131.7171;Inherit;False;Property;_TextureRatio;TextureRatio;32;0;Create;True;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-5387.52,648.7907;Inherit;False;Property;_Effect_Base_UVWarp_ScrollSpeed;Effect_Base_UVWarp_ScrollSpeed;6;0;Create;True;0;0;False;0;False;1;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;190;-3125.277,2190.984;Inherit;False;Property;_Effect_Scan_ScrollSpeed;Effect_Scan_ScrollSpeed;19;0;Create;True;0;0;False;0;False;0.1;-0.05;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-5381.064,72.0863;Inherit;False;Property;_GlobalUV_ScrollSpeed;GlobalUV_ScrollSpeed;0;0;Create;True;0;0;False;0;False;0;0.025;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;251;376.6124,625.272;Inherit;False;Property;_Effect_Mask_NoiseScrollSpeed;Effect_Mask_NoiseScrollSpeed;28;0;Create;True;0;0;False;0;False;3;0.02;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;214;-3000.842,2589.266;Inherit;False;Property;_Effect_Scan_UVWarpScale;Effect_Scan_UVWarpScale;17;0;Create;True;0;0;False;0;False;0.1;5.16;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;268;509.1152,709.3314;Inherit;False;257;ScriptTime;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-3462.007,-1544.513;Inherit;False;Property;_Effect_Base_UVWarp_NoiseScale;Effect_Base_UVWarp_NoiseScale;8;0;Create;True;0;0;False;0;False;1;9.13;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;91;-3459.863,-1262.795;Inherit;False;Property;_Effect_Base_UVWarp2_NoiseScale;Effect_Base_UVWarp2_NoiseScale;9;0;Create;True;0;0;False;0;False;8.48966;0;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;165;-2901.862,433.0799;Inherit;False;Property;_Effect_FBM_Octaves;Effect_FBM_Octaves;22;0;Create;True;0;0;False;0;False;0;5;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;164;-2899.514,357.8191;Inherit;False;Property;_Effect_FBM_Frequency;Effect_FBM_Frequency;21;0;Create;True;0;0;False;0;False;0;5;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;269;695.1152,730.3315;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;167;-2899.864,589.1237;Inherit;False;Property;_Effect_FBM_Gain;Effect_FBM_Gain;24;0;Create;True;0;0;False;0;False;0;0.13;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;166;-2899.689,507.9498;Inherit;False;Property;_Effect_FBM_Lacunarity;Effect_FBM_Lacunarity;23;0;Create;True;0;0;False;0;False;0;5;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;169;-2351.61,450.2768;Inherit;True;NoiseGenerator_KJ;-1;;20;16e20a82aed261a4daa8f1d0ce2e1beb;0;5;18;FLOAT2;0,0;False;22;FLOAT;0;False;19;INT;1;False;20;FLOAT;0;False;21;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;254;838.6125,618.272;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;168;-2351.982,189.0237;Inherit;True;NoiseGenerator_KJ;-1;;19;16e20a82aed261a4daa8f1d0ce2e1beb;0;5;18;FLOAT2;0,0;False;22;FLOAT;0;False;19;INT;1;False;20;FLOAT;0;False;21;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-3463.238,1462.603;Inherit;False;Property;_Effect_Wave_ScrollSpeed;Effect_Wave_ScrollSpeed;12;0;Create;True;0;0;False;0;False;0.1;0.079;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;246;803.6125,843.272;Inherit;False;Property;_Effect_Mask_PixelsNum;Effect_Mask_PixelsNum;26;0;Create;True;0;0;False;0;False;3;100;1;200;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-2586.04,-223.3909;Inherit;False;Property;_Effect_Base_UVTwirl_ScrollSpeed;Effect_Base_UVTwirl_ScrollSpeed;3;0;Create;True;0;0;False;0;False;1;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-2550.469,-749.1421;Inherit;False;Property;_Effect_Base_UVWarp_Intensity;Effect_Base_UVWarp_Intensity;7;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;247;1117.613,1034.272;Inherit;False;Property;_Effect_Mask_NoiseScale;Effect_Mask_NoiseScale;27;0;Create;True;0;0;False;0;False;3;30;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;191;-1939.365,2248.93;Inherit;False;Property;_Effect_Scan_Scale;Effect_Scan_Scale;18;0;Create;True;0;0;False;0;False;0.1;4.93;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;192;-1322.909,2513.307;Inherit;False;Property;_Effect_Scan_ModeLerp;Effect_Scan_ModeLerp;15;0;Create;True;0;0;False;0;False;0.1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;-2624.923,1244.62;Inherit;False;Property;_Effect_Wave_Scale;Effect_Wave_Scale;11;0;Create;True;0;0;False;0;False;5;4.46;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-2300.43,-472.9271;Inherit;False;Property;_Effect_Base_UVTwirl_Intensity;Effect_Base_UVTwirl_Intensity;4;0;Create;True;0;0;False;0;False;5.294117;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;250;1464.613,1201.472;Inherit;False;Property;_Effect_Mask_ResultPower;Effect_Mask_ResultPower;29;0;Create;True;0;0;False;0;False;3;0.5;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;170;-1467.474,242.6993;Inherit;True;NoiseGenerator_KJ;-1;;26;16e20a82aed261a4daa8f1d0ce2e1beb;0;5;18;FLOAT2;0,0;False;22;FLOAT;0;False;19;INT;1;False;20;FLOAT;0;False;21;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;187;-911.6371,1427.36;Inherit;False;Property;_Effect_Scan_ResultPower;Effect_Scan_ResultPower;16;0;Create;True;0;0;False;0;False;3;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-1637.252,968.8969;Inherit;False;Property;_Effect_Wave_ResultPower;Effect_Wave_ResultPower;13;0;Create;True;0;0;False;0;False;3;10;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-1587.014,-392.1959;Inherit;False;Property;_Effect_Base_NoiseScale;Effect_Base_NoiseScale;2;0;Create;True;0;0;False;0;False;1;54;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;173;-929.9067,-73.17261;Inherit;False;Property;_Effect_Base_ResultMul;Effect_Base_ResultMul;1;0;Create;True;0;0;False;0;False;1;3.7;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;82;-1372.88,1082.485;Inherit;False;Property;_Effect_Wave_ResultMul;Effect_Wave_ResultMul;10;0;Create;True;0;0;False;0;False;3;12.93;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;172;-1203.563,394.4741;Inherit;False;Property;_Effect_FBM_ResultMul;Effect_FBM_ResultMul;20;0;Create;True;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;188;-916.6371,1329.36;Inherit;False;Property;_Effect_Scan_ResultMul;Effect_Scan_ResultMul;14;0;Create;True;0;0;False;0;False;3;1.59;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;-566.0029,1032.072;Inherit;False;Property;_Effect_Mask_ResultMul;Effect_Mask_ResultMul;25;0;Create;True;0;0;False;0;False;3;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;255;654.6125,641.272;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=8BB98C0035AC8721EF495062AAC6CD03D3A09EC1